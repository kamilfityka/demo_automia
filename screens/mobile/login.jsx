        ...
        <div style={{ position: 'relative' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 11, marginBottom: 26 }}>
            ...
            <div style={{ lineHeight: 1.1 }}>
              <div style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: 19 }}>LeadBase</div>
              <div style={{ fontSize: 12, fontWeight: 500, opacity: 0.85 }}>by AutomiaCRM</div>
            </div>
          </div>
          <h1 style={{ fontSize: 26, lineHeight: 1.18, maxWidth: 320 }}>Zbieraj i obsługuj leady w jednym miejscu.</h1>
          <p style={{ fontSize: 14.5, lineHeight: 1.55, marginTop: 12, opacity: 0.92, maxWidth: 320 }}>Formularze, kanban i pełna historia każdego zgłoszenia — w Twojej kieszeni.</p>
        </div>
      </div>
